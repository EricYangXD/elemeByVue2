<template>
	<div class="header">
		<div class="content-wrapper">
			<div class="avatar">
				<img width="64" height="64" :src="seller.avatar"><!--用v-bind(:)来引用图片-->
			</div>
			<div class="content">
				<div class="title">
		...
		<div class="bulletin-wrapper" @click="showDetial">
			...
			<i class="icon-keyboard_arrow_right"></i><!--子元素绝对定位时，父元素应相对定位-->
		</div>
			...
			<div class="detial" v-show="detialShow">
				<div class="detail-wrapper clearfix">
					<div class="detail-main">
						...
						<div class="bulletin">
							<p class="content">{{seller.bulletin}}</p><!-- text-align:justify文字两端对齐 -->
						</div>
					</div>
				</div>
